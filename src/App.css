...
.tag-item { font-size: 0.9rem; color: #ddd; background: rgba(255,255,255,0.05); padding: 10px; border-radius: 8px; }
.tag-item span { color: #56CCF2; display: block; font-size: 0.95rem; margin-bottom: 2px; }
