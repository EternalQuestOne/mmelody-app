    ...
    <div className="app-root" onClick={() => setActiveMenu(null)}>
      <audio ref={audioRef} onEnded={handleNextSong} onTimeUpdate={() => {
        ...
        if(dur) {
          ...
          setElapsedTime(formatTime(cur));
          setRemainingTime(formatTime(dur - cur));
        }
      }} />
        ...
        <div className="modal-overlay" onClick={() => setIsPlaylistModalOpen(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
             <header className="modal-header-bar">
               ...
               <button className="modal-cancel-btn" onClick={() => setIsPlaylistModalOpen(false)}>Cancel</button>
             </header>
             <div className="new-playlist-input-group">
               ...
               <button className="modal-create-btn" onClick={async () => {
                 ...
                 if (data) setPlaylists([data[0], ...playlists]);
               }}>Create</button>
             </div>
        ...
        {activeTab === 'detail' && currentSong && (
          <div className="detail-view-container">
            ...
            <div className="detail-interaction-row">
              <button className="detail-inter-btn"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg></button>
              <button className="detail-inter-btn" onClick={() => setShowMoreDetails(!showMoreDetails)}><svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg></button>
              ...
              <button className="detail-inter-btn" onClick={handleStop}><svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><rect x="6" y="6" width="12" height="12" rx="1"/></svg></button>
            </div>

            <div className="detail-progress-container"><div className="progress-bar-bg"><div className="progress-bar-fill" style={{ width: `${progress}%` }}></div></div><div className="time-row"><span>{elapsedTime}</span><span>{remainingTime}</span></div></div>
      ...
      <nav className="bottom-footer">
        ...
        <button className={`footer-btn ${activeTab === 'playlists' ? 'active-tab' : ''}`} onClick={() => navigateTo('playlists')}><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg></button>
